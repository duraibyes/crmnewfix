  ...
  <head>
    ...
    <style>
      ...
      .form-panel.two {
        ...
        width: 100%;
        min-height: 100%;
        padding: 30px calc(10% + 60px) 60px 60px;
        transition: 0.3s ease;
        cursor: pointer;
      }
        ...
        $(document).ready(function () {
            ...
            $('#myform').validate({ // initialize the plugin
                ...
                submitHandler: function(form) {
                    // Use AJAX to submit the form data to function.php
                    $('#formResult').removeClass('text-success');
                    $('#formResult').removeClass('text-danger');

                    $.ajax({
                        type: 'POST',
                        url: "{{ route('verify-global-login')}}",
                        ...
                        success: function(response) {
                            ...
                            if( response.status === 0) {
                              ...
                              if( response.url) {
                                $('#formResult').html( response.message);
                                $('#formResult').addClass('text-success');
                                setTimeout(() => {
