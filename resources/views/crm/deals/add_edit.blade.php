                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="mobile_no" id="mobile_no" class="form-control" value="{{ $info->mobile_no ?? $lead_info->mobile_no ?? '' }}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group mt-1">
                            <label for="name" class="col-form-label">Email <span class="text-danger">*</span></label>                   
                            <input type="email" name="email" id="email" class="form-control" value="{{ $info->email ?? $lead_info->email ?? '' }}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group mt-1">
                            <label for="name" class="col-form-label"> City <span class="text-danger">*</span></label>                   
                            <input type="text" name="city" id="city" class="form-control" value="{{ $info->city ?? $lead_info->city ?? '' }}" autocomplete="off" required>
                        </div>
                    </div>
